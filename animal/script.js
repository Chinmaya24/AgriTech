document.addEventListener('DOMContentLoaded', () => {
  ...
  treatment: 'Preventive vaccination is critical: FMD twice yearly, HS annually, and Brucellosis as per schedule. Sanitize milking equipment and use post-milking teat dips to avoid mastitis. For internal parasites, follow deworming every 3–4 months. Isolate sick animals immediately. Provide oral rehydration and supportive care until veterinary treatment is available.',
      ...
      'Holstein Friesian': {
        ...
        image: 'images/holstein_friesian.png'
      },
      'Jersey': {
    ...
    poultry: {
      'Aseel': {
        ...
        image: 'images/aseel_chicken.png'
      },
      'Kadaknath': {
      ...
      'White Leghorn': {
        ...
        image: 'images/white_leghorn.png'
      }
    },
    pisciculture: {
      'Rohu (Labeo rohita)': {
    ...
    apiculture: {
      'Indian Hive Bee (Apis cerana indica)': {
        ...
        image: 'images/indian_hive_bee.png'
      },
    ...
    sericulture: {
      'Mulberry Silkworm (Bombyx mori)': {
        ...
        image: 'images/mulberry_silkworm.png'
      },
      'Tasar Silkworm (Antheraea mylitta)': {
        ...
        image: 'images/tasar_silkworm.png'
      }
    }
  };
  ...
  if (pageSection) {
    ...
    if (selectEl) {
      ...
      selectEl.addEventListener('change', (e) => {
        ...
        if (key && itemsObj[key]) {
          location.href = `breed.html?type=${encodeURIComponent(pageKey)}&name=${encodeURIComponent(key)}`;
        }
      });
    }
      ...
      gridEl.querySelectorAll('.breed-item').forEach((el) => {
        el.addEventListener('click', () => {
          ...
          if (name && itemsObj[name]) {
            location.href = `breed.html?type=${encodeURIComponent(pageKey)}&name=${encodeURIComponent(name)}`;
          }
        });
  ...
  (function initBreedPage() {
    ...
    if (back && type) back.href = `./${type}.html`;
    if (crumbType && type) {
